...
jQuery( function($) {
    function moveSliderButtons() {
        ...
        var capMar = document.querySelectorAll('.home-slider-container .slide-caption')[0].style.marginTop;
        ...
        var sliderPad = document.querySelectorAll( '.home-slider-container' )[0].style.paddingTop;
    ...
    jQuery( window ).resize( function() { return moveSliderButtons(); } );
